...
namespace FoodShop.Client.States;

public class CustomerAuthenticationStateProvider(ILocalStorageService localStorageService) : AuthenticationStateProvider
{
    ...
    private static ClaimsPrincipal SetClaimPrincipal(string name)
    {
    ...
    public async Task UpateAuthenticationState(string jwtToken)
    {
